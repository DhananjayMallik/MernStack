    ...
    <>
        ...
        <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
          ...
          <div className='flex gap-2 mb-6 mt-3'>
              {
                isEdit ? <>
                    ...
                    <button  onClick={(e)=>setIsEdit(false)} className='bg-green-500 border border-green-400 rounded-lg px-4 py-2'>Save</button>
                  </>
          ...
          <table className='min-w-full bg-white border rounded'>
            <thead>
              <tr>
                <th className='py-3 px-4 border-b text-left'>Comany</th>
