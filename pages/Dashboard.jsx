...
import { NavLink, Outlet, useNavigate } from 'react-router-dom';  // Correct import
  ...
  return (
    <div className='min-h-screen'>
      ...
      <div className='shadow py-4'>
        <div className='px-5 flex justify-between items-center'>
            ...
            <div className='flex items-center gap-3'>
                <p className='max-sm:hidden'>Welcome | JobHunt</p>
      ...
      <div className='flex items-start'>
            {/* left sidebar with option job and manage job and view application*/}
